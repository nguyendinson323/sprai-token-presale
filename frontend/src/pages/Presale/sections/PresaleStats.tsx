  ...
  return (
    <div className="bg-white rounded-sm shadow-lg p-6 mb-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-sm p-4">
        ...
        <div className="bg-gradient-to-br from-green-50 to-green-100 rounded-sm p-4">
        ...
        <div className="bg-gradient-to-br from-purple-50 to-purple-100 rounded-sm p-4">
        ...
        <div className="bg-gradient-to-br from-orange-50 to-orange-100 rounded-sm p-4">
